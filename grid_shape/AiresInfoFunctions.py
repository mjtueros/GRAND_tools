...
def GetZenithAngleFromSry(sry_file,outmode):
  try:
...
def GetAzimuthAngleFromSry(sry_file,outmode):
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def GetEnergyFromSry(sry_file,outmode):
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def GetPrimaryFromSry(sry_file,outmode):
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def GetSlantXmaxFromSry(sry_file,outmode): #To do. Handle when Xmax is not found, becouse the fit didnt converge
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def GetKmXmaxFromSry(sry_file,outmode): #To do. Handle when Xmax is not found, becouse the fit didnt converge, or becouse this is not ZHAireS, or its latest version
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
    ...
    #print("Warning: GetKmXmaxFromSry:file not found or invalid:"+sry_file)
    raise
    #return -1

def GetTaskNameFromSry(sry_file,outmode):
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def GetTotalCPUTimeFromSry(sry_file,outmode):
  try:
    datafile=open(sry_file,'r')
    with open(sry_file, "r") as datafile:
      for line in datafile:
...
def ReadAiresSry(sry_file,outmode):
...
def ReadAiresLgf(lgf_file,outmode):
...
def DeprecatedReadAiresSry(sry_file,outmode):
