...
def do_interpolation(array,new_pos, mypos, zenith, azimuth, phigeo=phigeo, thetageo=thetageo, shower_core=np.array([0,0,0]), DISPLAY=False):
#def do_interpolation(desired, array,zenith, azimuth, phigeo=phigeo, thetageo=thetageo, shower_core=np.array([0,0,0]), DISPLAY=False):
    ...
    positions: list of desired antenna positions
        positions[:,0]:x, positions[:,1]:y,positions[:,2]:z

    positions_sim: list of intial antenna positions
